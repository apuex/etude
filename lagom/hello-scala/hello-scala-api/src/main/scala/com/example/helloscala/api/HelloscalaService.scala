package com.example.helloscala.api
...
object HelloscalaService  {
  val TOPIC_NAME = "greetings"
}

/**
  * The hello-scala service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the HelloscalaService.
  */
trait HelloscalaService extends Service {
  ...
  override final def descriptor: Descriptor = {
    ...
    named("hello-scala")
      ...
      .withTopics(
        topic(HelloscalaService.TOPIC_NAME, greetingsTopic _)
